...
<table style="font-weight : bold; padding: 40px 50px;">
		...
		<table cellspacing="0px" style="margin-left:375px; margin-top:-10px; border:1px solid black; padding:5px 54px;">
			...
			<table style="border:2px black solid;margin-top:20px;" cellspacing="0px">
				...
				<tr>
					<td style="border-top:2px solid black;"><strong></strong><?php	if ((isset($_POST['cmpobjet'])) && (isset($_POST['cmpvetuste']))) { for($n=1; $n<= intval($_POST['cmpobjet']) ; $n++) { if (isset($_POST['objet'.$n])) { echo  htmlentities($_POST['objet'.$n])." "; if (isset($_POST['vetuste'.$n])) { echo htmlentities($_POST['vetuste'.$n])." ans <br>"; } } } } ?></td>
